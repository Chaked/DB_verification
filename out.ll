...
@2 = private constant [1 x %struct._list*] [%struct._list* inttoptr (i64 4 to %struct._list*)]
@3 = private global i32 0
@4 = private constant [1 x i32] [i32 1]
...
entry:
  ...
  %1 = add i32 %0, 1
  store i32 %1, i32* @5
  %2 = call i32 @__seahorn_get_value_i32(i32 %0, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @4, i32 0, i32 0), i32 1)
  ret i32 %2
}
...
entry:
  call void @__seahorn_mem_alloc(i8* null, i8* null, i64 3398, i64 8)
  call void @__seahorn_mem_alloc(i8* null, i8* null, i64 3395, i64 8)
  call void @__seahorn_mem_alloc(i8* null, i8* null, i64 3399, i64 8)
  ret void
}
